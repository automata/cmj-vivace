...
result. This enhances the fit of specific language syntaxes.
...
when apropriated) to guarantee maximum performance. The API is based
...
synthesizers, filters, analysers, mixers and even real time audio
engines to live coding. This motivated basic explorations of
multichannel expansion, filtering and audio effects, controling an
...
performancer, code and audience characterises the performance as live
...
Mr. Luporini and Mr. Rocha~\footnote{Videos were selected beforehand by
  Mr. Luporini alone without knowledge of the other performers.}. In
the 30 minutes performance, the audience started to take guidence from
messages given on the performance big screen and edited Vivace code
that was being played together with the starting four performers.
...
relation of lightness and brotherhood with the audience, i.e.\
...
resulted in a freak style, with images of monsters and funny dialogues
...
used those kind of pop-art: the people was facinated by the adherence
...
same happens on the desmistification of technology and the festive and
gregarious behaviour. At the performer-computer relation is where this
behaviour becomes concrete. More than the materials used in the live
...
explicitly define large music archs as nested sequences related to
